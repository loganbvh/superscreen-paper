...
def huber_squid():
    ...
    d_be = 0.2  # BE metal thickness
    d_i1 = 0.350  # I1 insulator thickness
    d_w1 = 0.23  # W1 metal thickness
    d_i2 = 0.350  # I2 insulator thickness
    d_w2 = 0.25  # W2 metal thickness
    ...
    layers = [
        ...
        sc.Layer("BE", london_lambda=5.00, thickness=d_be, z0=z0_be),
    ]
    films = [
