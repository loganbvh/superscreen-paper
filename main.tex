...
fig, axes = plt.subplots(2, 2, figsize=(8, 8), facecolor="w", constrained_layout=True)
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.55\textwidth]{examples/images/mesh.pdf}
    \caption{Computational meshes for }
    \label{fig:mesh}
\end{figure}
