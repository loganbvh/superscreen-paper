...
\begin{subfigure}{.4\textwidth}
  ...
  \caption{Screening current, uniform applied field model.}
...
\begin{subfigure}{.4\textwidth}
  ...
  \caption{Total magnetic field, uniform applied field model.}
...
\begin{subfigure}{.4\textwidth}
  ...
  \caption{Screening current, trapped flux model.}
...
\begin{subfigure}{.4\textwidth}
  ...
  \caption{Total magnetic field, trapped flux model.}
  \label{fig:square_ring_plot_fields}
\end{subfigure}

\caption{Sheet current $\vec{J}$ and magnetic field $\mu_0H_z$ distributions for the circular ring with a uniform applied field of 0.25 mT (top) and a circulating current of 1 mA (bottom) calculated using Code Block~\ref{code:ring_circulating_current}.}
...
\end{itemize}
\mintinline{python}{Solutions} also have several visualization methods built in (see Section~\ref{section:overview:visualization}).
