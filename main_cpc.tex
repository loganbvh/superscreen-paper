...
The model geometry is defined by creating an instance of \mintinline{python}{superscreen.Device}. Here we define a disk, a circular ring, and a square ring, and generate the computational mesh for each of them.
